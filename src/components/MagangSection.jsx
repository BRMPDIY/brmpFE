...
import { ChevronsDown, ChevronDown, CheckCircle2, FileText, Send, Building2, GraduationCap, Calendar, User, Phone, BookOpen, Award, CheckCircle, X } from 'lucide-react';
...
export default function MagangSection() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const code = `MAGANG-2026-${Math.floor(1000 + Math.random() * 9000)}`;
    setSubmitted({
      code,
      nama: formData.nama,
