...
import { ArrowLeft, Send, Upload, CheckCircle, FileText, Image as ImageIcon, X, MessageSquareWarning, MapPin, Calendar, User, Phone, Mail, ShieldAlert } from 'lucide-react';
...
export default function PengaduanPage() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const code = `DUS-2026-${Math.floor(1000 + Math.random() * 9000)}`;
    setSubmitted({
      code,
      nama: formData.nama,
      nik: formData.nik,
