...
import { ArrowLeft, Send, Upload, CheckCircle, FileText, Image as ImageIcon, X, ShieldCheck, MessageCircle, HelpCircle } from 'lucide-react';
...
export default function KonsultasiPage() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const code = `KON-2026-${Math.floor(1000 + Math.random() * 9000)}`;
    setSubmitted({
      code,
      nama: formData.nama,
      nik: formData.nik,
