...
import { ArrowLeft, Send, Upload, CheckCircle, FileText, X, Volume2, Calendar, Building2, User, Phone, Mail, MapPin } from 'lucide-react';
...
export default function NarasumberPage() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const code = `NAR-2026-${Math.floor(1000 + Math.random() * 9000)}`;
    setSubmitted({
      code,
      nama: formData.nama,
